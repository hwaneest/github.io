...
<fieldset>
  <h2 id="list_types">강의</h2>
    ...
    <ul>
      ...
      <li>
        (기업교육) DT University 데이터분석 기본 교육 / 하나금융그룹 / 2021.08
      </li>
      <li>
...
<fieldset>
  <h2 id="list_types">Lecture</h2>
    ...
    <ul>
      <li>
        (Employee Training) Python programming for Data Analysis (Advanced) / Hyundai Glovis / 2022.04 ~ 2022.05
      </li>
      <li>
        (Employee Training) Python programming for Data Analysis (Advanced) / Hyundai Glovis / 2022.02 ~ 2022.03
      </li>    
      <li>
        2021 Elice AI Track(2nd) Data Analytics Class / Ministry of Employment and Labor / 2021.08 ~ 2021.09
      </li>
      <li>
        (Employee Training) DT University Data Analytics Basic Class / Hana Financial Group / 2021.08
      </li>
      <li>
